  ...
  return (
    <div className="font-bold px-20 py-5 w-full h-full text-white text-center bg-gray-900 margin-auto">
      ...
      <article className="text-lg">
        ...
        tym samym miejscu w słowie do zgadnięcia i w słowie wpisanym, zostanie
        podświetlona na zielono. - Literka która jest w słowie do zgadnięcia,
        ale nie znajduje się na dobrej pozycji, zostanie podświetlona na żółto.
      ...
      <article className="text-lg">
        ...
        jest za długie) - Dodanie kolejnej próby - Zapytanie o długość słowa do
        zgadnięcia, w porównaniu do ostatnio wpisanego słowa. Dostaniesz
        informacje czy słowo jest dłuższe, krótsze czy takie samo. - Usunięcie z
        klawiatury jednej literki, której nie ma w słowie do zgadnięcia.
      </article>
    </div>
  );
};
